...
if (_type == network_type_data) 
	...
	var _type_string = _packet.type;
	var _data = _packet.data;
	if (is_undefined(_type_string) || is_undefined(_data))
		{
		crash("[obj_private_lobby_ui: Async - Networking] Received a packet with an invalid type (", _type_string, ") or invalid data (", _data, ")");
		}
