...
function character_leon_init()
	...
	if (_set_sprites)
		...
		my_sprites[$ "Entrance"			] = anim_define(spr_leon_idle, anim_define(spr_leon_idle));
		my_sprites[$ "Idle"				] = spr_leon_idle;
		my_sprites[$ "Crouch"			] = anim_define(spr_leon_crouch, anim_define(spr_leon_crouchloop));
		my_sprites[$ "Walk"				] = spr_leon_run;
		my_sprites[$ "Walk_Turn"		] = spr_leon_run;
		my_sprites[$ "Dash"				] = spr_leon_run;
		my_sprites[$ "Run"				] = spr_leon_run;
		...
		my_sprites[$ "DJump_Rise"		] = anim_define(spr_leon_jump, anim_define(spr_leon_midjump));
		my_sprites[$ "DJump_Mid"		] = -1;
		my_sprites[$ "DJump_Fall"		] = -1;
		my_sprites[$ "DFastfall"		] = -1;
				 
		my_sprites[$ "Airdodge"			] = anim_define_ext(spr_leon_airdodge, 0, anim_calculate_speed(spr_leon_airdodge, airdodge_startup + airdodge_active + airdodge_endlag));
		my_sprites[$ "Waveland"			] = spr_leon_crouch;
		my_sprites[$ "Rolling"			] = spr_leon_airdodge;
		my_sprites[$ "Shield"			] = anim_define(spr_leon_block, anim_define(spr_leon_blockloop));
		...
		my_sprites[$ "Hitstun"			] = spr_leon_hit;
		my_sprites[$ "Tumble"			] = spr_leon_hit;
		my_sprites[$ "Helpless"			] = spr_leon_freefall;
		my_sprites[$ "Magnet"			] = spr_leon_hit;
		my_sprites[$ "Flinch"			] = spr_leon_hit;
		...
		my_sprites[$ "Ledge_Snap"		] = spr_leon_ledge;
		my_sprites[$ "Ledge_Hang"		] = spr_leon_ledge;
		my_sprites[$ "Ledge_Getup"		] = spr_leon_crouchloop;
		my_sprites[$ "Ledge_Jump"		] = spr_leon_jump;
		my_sprites[$ "Ledge_Roll"		] = spr_leon_airdodge;
		my_sprites[$ "Ledge_Attack"		] = spr_leon_groundweak;
		...
		my_sprites[$ "Wall_Jump"		] = spr_leon_walljump;
	
		my_sprites[$ "Star_KO"			] = spr_leon_hit;
		my_sprites[$ "Screen_KO"		] = spr_colt_screenko;
				 
		my_sprites[$ "Grabbing"			] = spr_basic_grabbing;
		my_sprites[$ "Grabbed"			] = spr_leon_hit;
		my_sprites[$ "Grab_Release"		] = anim_define(spr_leon_crouch, anim_define(spr_leon_crouchloop));
		}
	}
