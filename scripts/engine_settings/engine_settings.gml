...
#macro version_string					"1.4.7" //{string} The current game version.
...
#macro online_win_screen_time_limit		4 //{int} The maximum number of seconds players can stay on the win screen after online matches.
...
#macro touch_devices_limit				5 //{int} The number of mouse/touch devices to check. By default this is 5 so you can have up to 5 fingers touching at the same time on a mobile device.
