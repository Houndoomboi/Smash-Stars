function spike_strong_draw_end()
	{
	//Draw Script
	if (!variable_struct_exists(custom_attack_struct, "draw_frame"))
		{
	...
	draw_sprite_ext(spr_spike_strong, custom_attack_struct.draw_frame, object_surface_size_half + (50 * facing), object_surface_size_half, facing, 1, 0, c_white, 1);
