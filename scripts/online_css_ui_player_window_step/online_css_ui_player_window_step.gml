function online_css_ui_player_window_step()
	...
	_device_id = _custom.device_id; //Default to the device the player first used on the previous menu
	var _confirm = false;
	var _option = false;
	var _back = false;
	//var _delete = false;
	...
	for (var i = 0; i < array_length(_array); i++)
		...
		if (_temp.x || _temp.y)
			...
			_stick_values = mis_device_stick_values(_id);
