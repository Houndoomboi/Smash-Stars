...
function ggmr_session_perform_rollback()
	...
	with (obj_ggmr_session) 
		...
		if (session_rollback_needed)
			...
			script_execute(session_callbacks.load_game, session_frames[@ _rollback_frame][@ GGMR_FRAME.game_state]);
			...
			for (session_running_relative_frame = _rollback_frame; session_running_relative_frame < GGMR_RELATIVE_FRAME; session_running_relative_frame++) 
				...
				if (session_running_relative_frame == ggmr_session_frame_relative(_save_frame)) 
					{
					script_execute(session_callbacks.save_game, session_frames[@ session_running_relative_frame][@ GGMR_FRAME.game_state]);	
				...
				script_execute(session_callbacks.advance_frame, session_frames[@ session_running_relative_frame][@ GGMR_FRAME.inputs], session_running_relative_frame);
