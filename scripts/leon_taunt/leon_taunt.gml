	...
	if (run)
		...
		switch (_phase)
			...
			case PHASE.start:
				{
				//Animation
				anim_set(spr_leon_taunt, 0, 0.15);
				attack_frame = anim_calculate_length(spr_leon_taunt, 0.15);
				return;
				}
			case 0:
				{
			//Sound
				if (attack_frame == 52)
					{
					game_sound_play(prng_choose(1, Leon_Watchthis, Leon_Lead, Leon_hahahaha));
					}
